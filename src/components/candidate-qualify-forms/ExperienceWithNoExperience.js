        ...
        <div className="">
          <form onSubmit={handleSubmit}>
            <div className="container-fluid">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      { value: " Company Closed", label: " Company Closed" },
              ...
              <div className={`${styles.container}`}>
                <h2 className={`${styles.Heading}`}>Previous Work Details</h2>
              </div>
              {/* break */}
              ...
              <div className="row mt-5 mb-4">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  {!formData.iscompanynameValid && (
                    <div style={{ color: "red" }} className="error-message">
                      Please enter the previous company name.
                    </div>
                  )}
                </div>
                <div className="col-md-6 mb-3">
                  <label htmlFor="currentcompany" className="form-label">
                    <strong>Previous work location?</strong>
                  </label>
                  <input
                    type="text"
                    className={`form-control ${
                ...
                <div className="col-md-6 mb-3">
                  ...
                  >
                    <option value="">Select previous job type</option>
                  ...
                  {!formData.isCurrentjobValid && (
                    <div style={{ color: "red" }} className="error-message">
                      Please select previous job type.
                    </div>
                  )}
                </div>
                <div className="col-md-6 mb-3">
                  ...
                  >
                    <option value="">Select Previous work hours</option>
                  ...
                  {!formData.isCurrentworkhoursValid && (
                    <div style={{ color: "red" }} className="error-message">
                      Please select a previous work hours.
                    </div>
                  )}
                </div>
                <div className="col-md-6 mb-3">
