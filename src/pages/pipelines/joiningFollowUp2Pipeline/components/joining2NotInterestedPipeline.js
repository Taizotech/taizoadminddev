...
import Joining2NotInterestedFilter from "./joining2NotInterestedFilter";

function Joinning2NotInterestedPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joinningFollowUp2NotInterested
  );
...
export default Joinning2NotInterestedPipeline;
