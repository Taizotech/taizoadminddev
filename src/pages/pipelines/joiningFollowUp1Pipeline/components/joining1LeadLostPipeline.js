...
import Joining1LeadLostFilter from "./joining1LeadLostFilter";

function Joining1LeadLostPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joiningFollowUp1LeadLost
  );
...
export default Joining1LeadLostPipeline;
