...
import JoiningDayNotInterestedFilter from "./joiningDayNotInterestedFilter";

function JoiningDayNotInterestedPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joiningDayNotInterested
  );
...
export default JoiningDayNotInterestedPipeline;
