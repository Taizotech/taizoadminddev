...
import JoiningDayLeadLostFilter from "./joiningDayLeadLostFilter";

function JoiningDayLeadLostPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.joiningDayLeadLost
  );
  ...
  function submitLeadLost() {
    PutjoinedDayLeadLost(leadDetails.id).then(() => {
...
export default JoiningDayLeadLostPipeline;
