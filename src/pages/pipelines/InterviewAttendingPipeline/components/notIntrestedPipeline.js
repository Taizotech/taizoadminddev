...
import AttendingNotInterestedFilter from "./notInterestedFilter";

function NotInterestedPipeline() {
  const [leadData, setLeadData] = useState({
    data: [],
  });

  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.attendingNotInterested
  );
...
export default NotInterestedPipeline;
