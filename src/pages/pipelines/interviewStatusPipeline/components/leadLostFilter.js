...
function StatusLeadLostFilter({ onclose }) {
  let filterDetails = useSelector(
    (state) => state.CandidatePipelineDetails.interviewStatusLeadLost
  );
...
export default StatusLeadLostFilter;
