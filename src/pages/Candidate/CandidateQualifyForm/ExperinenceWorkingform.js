...
import {
  ...
  getJobIndustries,
  getKeySkills,
  PutExperiencecurrentStatus,
  PutExperiencedetails,
  PutExperienceWorkDetails,
  PutExperienceSalaryDetails,
  PutEducationalDetails,
  PutExperienceExpertiseDetails,
  PutexperienceJobLocationDetails,
  PutexperienceBasicDetails,
  PutexperienceEmergencyDetails,
  PutexperienceOtherDetails,
...
export function ExperinenceWorkingform({
  mobilenumber,
  whatsappNumber,
  Reloadpage,
  candidateStatus,
  ...
  const handleNextStep = async (currentStep) => {
    switch (currentStep) {
      case 0:
        ...
        try {
          const response = await PutExperiencecurrentStatus(
            object,
            mobilenumber
          );
      ...
      case 1:
        ...
        try {
          const response = await PutExperiencedetails(obj, mobilenumber);
      ...
      case 2:
        ...
        try {
          const response = await PutExperienceWorkDetails(ob, mobilenumber);
      ...
      case 3:
        ...
        try {
          const response = await PutExperienceSalaryDetails(objc, mobilenumber);
      ...
      case 4:
        ...
        // Making the API call
        try {
          const response = await PutEducationalDetails(objce, mobilenumber);
      ...
      case 5:
        ...
        try {
          const response = await PutExperienceExpertiseDetails(
            objct,
            mobilenumber
          );
      ...
      case 6:
        ...
        try {
          const response = await PutexperienceJobLocationDetails(
            experienceWorkingField.CandidatePreferredCity,
            experienceWorkingField.PfEsiAccountRadio,
            mobilenumber
          );
      ...
      case 7:
        ...
        if (!experienceWorkingField.CandidateFirstName) {
          setValidity((prevState) => ({
            ...prevState,
        ...
        if (!experienceWorkingField.CandidateLastName) {
          setValidity((prevState) => ({
            ...prevState,
        ...
        const candidateDOB = new Date(experienceWorkingField.CandidateDOB);
        ...
        try {
          const response = await PutexperienceBasicDetails(
            basicDetailsObj,
            mobilenumber
          );
      ...
      case 8:
        ...
        try {
          const response = await PutexperienceEmergencyDetails(
            emergencyDetailsObj,
            mobilenumber
          );
      ...
      case 9:
        ...
        try {
          const response = await PutexperienceOtherDetails(
            experienceWorkingField.RotationalShift,
            experienceWorkingField.Accomodation,
            experienceWorkingField.CvResume,
    ...
    const fetchData = async () => {
      try {
        ...
        if (data.canLeadDetails) {
          ...
          if (industry && expYears && expMonths) {
            nextStep = 2;
...
export default ExperinenceWorkingform;
