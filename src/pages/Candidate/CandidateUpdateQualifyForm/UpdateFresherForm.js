...
import {
PutUpdateFresherBasicDetails,
PutUpdateFresherEmergencyDetails,
  PutUpdateFrehserExpertise,
  PutUpdateFresherJobLocation,
  PutUpdatefresherEducationalDetails,
  PutUpdateFresherOtherDetails,
  PutUpdateFresherStatus,
  putUpdatefresherSalarayDetails,
...
export function UpdateFresherForm({
  mobilenumber,
  whatsappNumber,
  Reloadpage,
}) {
  ...
  useEffect(() => {
    ...
    const step6Valid =
      ...
      fresherWorkingField.CandidateWhtsappNumber &&
      fresherWorkingField.CandidateCurrentLocation &&
      fresherWorkingField.CandidateFirstName.trim() !== "" &&
      fresherWorkingField.CandidateLastName.trim() !== "" &&
  ...
  const handleNextStep = async (currentStep) => {
    switch (currentStep) {
      case 0:
        ...
        try {
          const response = await PutUpdateFresherStatus(
            fresherWorkingField.PostionApply,
            mobilenumber
          );
      ...
      case 1:
        ...
        try {
          const response = await putUpdatefresherSalarayDetails(object, mobilenumber);
      ...
      case 2:
        ...
        try {
          const response = await PutUpdatefresherEducationalDetails(
            obj,
            mobilenumber
          );
      ...
      case 3:
        ...
        try {
          const response = await PutUpdateFrehserExpertise(
            Expertiseobject,
            mobilenumber
          );
      ...
      case 4:
        ...
        try {
          const response = await PutUpdateFresherJobLocation(
            fresherWorkingField.CandidatePreferredCity,
            mobilenumber
          );
      ...
      case 5:
        ...
        if (!fresherWorkingField.CandidateFirstName.trim()) {
          setValidity((prevState) => ({
            ...prevState,
        ...
        if (!fresherWorkingField.CandidateLastName.trim()) {
          setValidity((prevState) => ({
            ...prevState,
        ...
        if (!fresherWorkingField.CandidateDOB.trim()) {
          setValidity((prevState) => ({
            ...prevState,
        ...
        try {
          const response = await PutUpdateFresherBasicDetails(
            basicDetailsObj,
            mobilenumber
          );
      ...
      case 6:
        ...
        try {
          const response = await PutUpdateFresherEmergencyDetails(
            emergencyDetailsObj,
            mobilenumber
          );
      ...
      case 7:
        ...
        try {
          const response = await PutUpdateFresherOtherDetails(
            fresherWorkingField.RotationalShift,
            fresherWorkingField.Accomodation,
            fresherWorkingField.CvResume,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(data, "data of object");
...
export default UpdateFresherForm;
