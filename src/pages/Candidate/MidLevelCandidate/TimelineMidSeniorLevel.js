...
import style from "../FacebookMeta/FacebookMetaLeadTimeline.module.scss";
...
import TimelineMetaDetails from "../FacebookMeta/TimelineMetaDetails";
import AddNotesFBLead from "../FacebookMeta/PostCandidateNotes";
...
export default function TimelineMidSeniorLevel({
  midSeniorCanId,
  midSeniorSorcingId,
}) {
  ...
  const [timeLine, setTimeLine] = useState({
    content: [],
    totalPages: 0,
    midSeniorCanId: midSeniorCanId ? midSeniorCanId : null,
    midSeniorSorcingId: midSeniorSorcingId ? midSeniorSorcingId : null,
    startDate: "",
    endDate: "",
    eventType: null,
  });
  ...
  function handleClosePopup() {
    Dispatch(
      showHideDetailsActions.setCandidateLeadDetails({ showTimeLine: false })
    );
    console.log("done");
  }
      ...
      <div>
        <div>
          <div className="row">
            ...
            {/* <div className="col-9">
              {" "}
              <h4 className="text-center">MidSeniorLevel Timeline </h4>
            </div>
                ...
                >
                  ...
                  <Card sx={{ cursor: "pointer" }}>
                    <div className="p-3">
                      ...
                      <div>
                        {!(
                          element.notes == "undefined" || element.notes == null
                        ) ? (
                          <>
                            <strong>Notes</strong>: &nbsp;
                            {textTruncate(capitalizeWords(element.notes, 20))}
                          </>
                        ) : (
                          ""
                        )}
