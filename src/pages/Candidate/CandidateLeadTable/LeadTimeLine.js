...
import style from "./CandidateLeadTimeline.module.scss";
...
export default function CandidateLeadTimeline({ canLeadId }) {
      ...
      <div>
        {/* <div>
          <div className="row">
            ...
            <div className="col-9">
              {" "}
              <h4 className="text-center">Candidate Lead's Timeline </h4>
            </div>
                ...
                childComponent={
                  <>
                    <AddNotesCandidateLead
                      canId={candidateLeadDetails.leadTimeLine.canLeadId}
                      close={() => {
